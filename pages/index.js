                ...
                <Dropzone />
                  <div className="md:flex-1 mb-3 mx-2 mt-16 lg:mt-0">
                    ...
                    <p className="text-lg leading-loose">
                        <span className="text-red-500 font bold">ReactNodeSend</span> te permite compartir archivos con cifrado de extremo a extremo y un archivos que es eliminado despues de ser descargado.
                         Asi que puedes mantener lo que comaprtes en priado y asegurarte de que tus cosas no permanezcan en linea para siempre.
                    </p>
